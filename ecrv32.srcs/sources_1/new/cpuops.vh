...
`define CPUUARTREAD				8
`define CPUSTALL				9
`define CPUFETCH_MASK				10'b0000000001
`define CPUCACHEFILLWAIT_MASK		10'b0000000010
`define CPUICACHEFILL_MASK			10'b0000000100
`define CPULOADCOMPLETE_MASK		10'b0000001000
`define CPULOADWAIT_MASK			10'b0000010000
`define CPUSTORE_MASK				10'b0000100000
`define CPUEXEC_MASK				10'b0001000000
`define CPURETIREINSTRUCTION_MASK	10'b0010000000
`define CPUUARTREAD_MASK			10'b0100000000
`define CPUSTALL_MASK				10'b1000000000
// ==============================================================
